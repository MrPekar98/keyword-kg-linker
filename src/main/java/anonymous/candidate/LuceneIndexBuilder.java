...
public final class LuceneIndexBuilder
{
    ...
    public static void build(Set<anonymous.candidate.Document> documents, File directory) throws IOException
    {
    ...
    private static void load(Set<anonymous.candidate.Document> documents, IndexWriter writer)
    {
